...
insert into users (id, user_name, email, password) values (-2, 'user2.0', 'ema_il@gmx.com', 'passme');
...
insert into exhibition(id, title, user_id) values (-3, 'Fotos von Künstlern', -2);
