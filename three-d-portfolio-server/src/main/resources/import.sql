insert into users (id, user_name, email, password) values (-1, 'emaemaxd', 'email@gmx.com', 'passme');

insert into theme(id, model_path, light_intensity) values (10, '~/test.c4d', 0.0 );
