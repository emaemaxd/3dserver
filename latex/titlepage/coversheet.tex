...
\def\title{3D Portfolio Gallery – Server}
%
...
%
\def\dep{Höheren Abteilung für IT-Medientechnik} % or IT-Medientechnik
%
% enter the student names
%
\def\nameone{Ema Halilovic}
%\def\namethree{Sebastian Schwammal}
%\def\namefour{Sabine Schwammal}
%
% enter the name of the supervisor 
% TODO check if right
\def\firstreferee{Patricia Engleitner}
\def\secondreferee{Natascha Rammelmüller}
%
% enter information about external partners or comment the line
%
% \def\assist{Petra Programmierer, Initech Inc.}
%
% enter month and year > TODO ASK ob September or what
\def\date{Dezember 2023}
%
